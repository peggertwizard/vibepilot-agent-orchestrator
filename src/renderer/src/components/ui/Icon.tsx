...
const REGISTRY = {
  ...
  stop: OctagonX,
  // Pause holds the queue; play releases it. Deliberately the transport pair, because that is
  // the one metaphor everyone already reads correctly without a label.
  pause: Pause,
  play: Play,
  warn: TriangleAlert,
