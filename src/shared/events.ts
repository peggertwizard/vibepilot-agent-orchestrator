...
export type DomainEvent =
  ...
  /**
   * A project's settings changed.
   *
   * Every other pane held its own copy of the project row and nothing told them it had moved,
   * so saving a setting updated Settings and left the board, the composer and the header on
   * the old value until something unrelated happened to refresh them.
   */
  | { type: 'projects:changed'; projectId: string }
